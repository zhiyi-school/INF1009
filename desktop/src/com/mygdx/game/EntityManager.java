...
public class EntityManager {
	...
	public EntityManager(World world, OrthographicCameraController orthographicCameraController) {
		...
		Player1 = new PlayableCharacter(world, "PlayableCharacter.png", 0, 300, 200, 100, 5, false, true);
		pcList.add(Player1);
		
		Enemy = new NonPlayableCharacter(world, "Enemy.png", 400, 100, 200, 100, 10, true);
		npcList.add(Enemy);
		
		Item = new NonPlayableCharacter(world, "Weapon.png", 520, 280, 200, 100, 10, false);
		npcList.add(Item);
	...
	public void update(float deltaTime) {
    	...
    	// Call update() method to apply gravity for NonPlayableCharacters
    	for (NonPlayableCharacter npc : npcList) {
